...
$cart = $context->cart;
$bankwire = Module::getInstanceByName('bankbii');
...
$bankwire->validateOrder($cart->id, Configuration::get('PS_OS_BANKBII'), $total, $bankwire->displayName, null, array(), (int)$currency->id, false, $customer->secure_key);
